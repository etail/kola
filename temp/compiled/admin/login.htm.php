...
<div class="login_box">
<div class="login_con">
<div class="login_logo"><a href="http://www.ecmoban.com/" target="_blank"><img src="images/login_logo.png" /></a></div>
...
<form method="post" action="privilege.php" name='theForm' onsubmit="return validate()">
  <table cellspacing="0" cellpadding="0" border="0" align="center" width="320">
    <tr>
      <td height="90" align="center" valign="middle" style="font-size:25px; color:#333; font-family:'宋体';">ECShop管理中心</td>
    </tr>
    <tr>
      <td align="center" >
      	<table>
          ...
          <tr>
            <td height="34" colspan="1" align="left" style="padding-top:18px;">
            	<div class="jizhu_label">
                    ...
                    <label for="jizhu_label"><?php echo $this->_var['lang']['remember']; ?></label>
                </div>
            </td>
