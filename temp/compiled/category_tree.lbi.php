...
?>
  ...
  <a  <?php if (($this->_foreach['no']['iteration'] <= 1)): ?> style="border-top:none" <?php endif; ?> href="<?php echo $this->_var['cat']['url']; ?>" class="  f_ll" ><?php echo htmlspecialchars($this->_var['cat']['name']); ?></a>
