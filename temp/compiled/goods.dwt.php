  ...
  <div class="AreaR">
   ...
   <div id="goodsInfo" class="clearfix">
    ...
    <div style="text-align:center; position:relative; width:100%;">
      ...
      <a href="<?php echo $this->_var['prev_good']['url']; ?>"><img style="position: absolute; left:0;" alt="prev" src="themes/ecmoban_kaola2016/images/up.gif" /></a>
      <?php endif; ?>
      <a href="javascript:;" onclick="window.open('gallery.php?id=<?php echo $this->_var['goods']['goods_id']; ?>'); return false;"><img alt="zoom" src="themes/ecmoban_kaola2016/images/zoom.gif" /></a>
      <?php if ($this->_var['next_good']): ?>
      <a href="<?php echo $this->_var['next_good']['url']; ?>"><img style="position: absolute;right:0;"  alt="next" src="themes/ecmoban_kaola2016/images/down.gif" /></a>
      <?php endif; ?>
      </div>
...
?>
          ...
          <td bgcolor="#FFFFFF">
          <a href="javascript:addPackageToCart(<?php echo $this->_var['package_goods']['act_id']; ?>)" style="background:transparent"><img src="themes/ecmoban_kaola2016/images/bnt_buy_1.gif" alt="<?php echo $this->_var['lang']['add_to_cart']; ?>" /></a>
          </td>
        </tr>
      </table>
       <?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?>
