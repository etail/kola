   ...
   <?php if (isset ( $this->_var['goods_list'] )): ?>
     ...
     <ul class="goods_list">
        ...
        <?php if ($this->_var['intromode'] == 'best'): ?>
         ...
         <img src="themes/ecmoban_kaola2016/images/display_mode_list<?php if ($this->_var['pager']['display'] == 'list'): ?>_act<?php endif; ?>.gif" alt="<?php echo $this->_var['lang']['display']['list']; ?>"></a></li>
         <li> <a href="javascript:;" onClick="javascript:display_mode('grid')">
         <img src="themes/ecmoban_kaola2016/images/display_mode_grid<?php if ($this->_var['pager']['display'] == 'grid'): ?>_act<?php endif; ?>.gif" alt="<?php echo $this->_var['lang']['display']['grid']; ?>"></a></li>
         <li style="margin-right: 10px;"> <a href="javascript:;" onClick="javascript:display_mode('text')">
         <img src="themes/ecmoban_kaola2016/images/display_mode_text<?php if ($this->_var['pager']['display'] == 'text'): ?>_act<?php endif; ?>.gif" alt="<?php echo $this->_var['lang']['display']['text']; ?>"></a></li>
          ...
          <?php echo $this->html_options(array('options'=>$this->_var['lang']['order'],'selected'=>$this->_var['pager']['search']['order'])); ?>
            ...
            <li style="margin-top: -4px;*margin-top: 0;"><input type="image" name="imageField" src="themes/ecmoban_kaola2016/images/bnt_go.gif" alt="go"/></li>
             <li> <input type="hidden" name="page" value="<?php echo $this->_var['pager']['page']; ?>" /></li>
             <li> <input type="hidden" name="display" value="<?php echo $this->_var['pager']['display']; ?>" id="display" /></li>
...
?>
                <?php if ($this->_var['goods']['goods_id']): ?>
                 <div class="goodsItem">
                       ...
                       <p style="height: 36px; overflow: hidden;"><a href="<?php echo $this->_var['goods']['url']; ?>" title="<?php echo htmlspecialchars($this->_var['goods']['name']); ?>"><?php echo $this->_var['goods']['goods_name']; ?></a></p>
                       <?php if ($this->_var['show_marketprice']): ?>
