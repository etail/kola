  ...
  <div class="box_1">
    <h3>
      ...
      <form method="GET" class="sort" name="listform">
        <font style="position: relative; *top: -3px;"><?php echo $this->_var['lang']['btn_display']; ?>：</font>
        <a href="javascript:;" onClick="javascript:display_mode('list')" style="position: relative; top: -3px; *top: -5px; "><img src="themes/ecmoban_kaola2016/images/display_mode_list<?php if ($this->_var['pager']['display'] == 'list'): ?>_act<?php endif; ?>.gif" alt="<?php echo $this->_var['lang']['display']['list']; ?>"></a>
        <a href="javascript:;" onClick="javascript:display_mode('grid')" style="position: relative; top: -3px; *top: -5px; "><img src="themes/ecmoban_kaola2016/images/display_mode_grid<?php if ($this->_var['pager']['display'] == 'grid'): ?>_act<?php endif; ?>.gif" alt="<?php echo $this->_var['lang']['display']['grid']; ?>"></a>
        <a href="javascript:;" onClick="javascript:display_mode('text')" style="position: relative; top: -3px; *top: -5px; "><img src="themes/ecmoban_kaola2016/images/display_mode_text<?php if ($this->_var['pager']['display'] == 'text'): ?>_act<?php endif; ?>.gif" alt="<?php echo $this->_var['lang']['display']['text']; ?>"></a>&nbsp;&nbsp;
